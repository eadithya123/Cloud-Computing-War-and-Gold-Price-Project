...
def lambda_handler(event, context):
    ...
    # ── Step 1: Download best model from S3 ──────────────────────────────────
    s3 = boto3.client("s3")
    ...
    # ── Step 2: Fetch latest gold price history from S3 ──────────────────────
    # We need historical data to compute ma7, ma14 (need at least 14 rows)
    ...
    # Fetch today's fresh gold price
    ...
    # Append today's row to historical data for rolling calculations
    ...
    # ── Step 3: Fetch today's war news sentiment ──────────────────────────────
    articles = []
    for url in FEEDS:
    ...
    # ── Step 4: Compute features for today's row ──────────────────────────────
